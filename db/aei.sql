...
--
-- Servidor: localhost
-- Tiempo de generación: 05-04-2016 a las 01:28:49
...
CREATE TABLE `newQuery` (
  ...
  `datec` timestamp NULL COMMENT 'fecha y hora de respuesta',
  `mgm` text NOT NULL,
...
--
ALTER TABLE `chats`
  MODIFY `idchats` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
--
-- AUTO_INCREMENT de la tabla `newQuery`
--
ALTER TABLE `newQuery`
  MODIFY `idnewQuery` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
